...
= Phantom Metal Taste
image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=openssourcesecurity[OpenSSF Best Practices,link="https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/phantom-metal-taste"]
...
See link:.github/CONTRIBUTING.md[CONTRIBUTING.md] for detailed guidelines.
