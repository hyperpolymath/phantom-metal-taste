...
:experimental:
:url-github: https://github.com/hyperpolymath/phantom-metal-taste
:url-gitlab: https://gitlab.com/hyperpolymath/phantom-metal-taste
:url-bitbucket: https://bitbucket.org/hyperpolymath/phantom-metal-taste
:url-codeberg: https://codeberg.org/hyperpolymath/phantom-metal-taste

Phantom sensory experience simulation
...
phantom-metal-taste is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
